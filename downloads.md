...
{% hint style="info" %}
* 这些程序均由其他开发者完成与我们并没有关系，当您在使用过程中出现了错误或问题我们可能无法解决，请联系程序开发者。
* 下载链接大部分为 Github 或官方链接，当项目发生更改或一些网络问题导致您可能无法下载或下载过慢，为此我们提供了国内备份下载！
* 我们会不定期更新工具，部分工具由于兼容性问题我们暂提供稳定版本。
{% endhint %}
...
| 名称 | 支持系统 | 版本 | 下载链接 |
| :--- | :--- | :--- | :--- |
| Telegram for Windows | Windows 7+ | v2.3.1 | [官方下载](https://telegram.org/dl/desktop/win) |
| Telegram for Windows Portable | Windows 7+ | v2.3.1 | [官方下载](https://telegram.org/dl/desktop/win_portable) |
| Telegram for macOS \(App Store\) | macOS 10.12+ ×64 | v7.0 | [App Store](https://apps.apple.com/us/app/telegram/id747648890) |
| Telegram for macOS \(dmg\) | macOS 10.10+ ×64 | v7.0 | [官方下载](https://osx.telegram.org/updates/Telegram.dmg) |
| Telegram for Linux 32bit | Linux ×32 | v2.3.2 | [官方下载](https://updates.tdesktop.com/tlinux32/tsetup32.2.3.2.tar.xz) |
| Telegram for Linux 64bit | Linux ×64 | v2.3.2 | [官方下载](https://updates.tdesktop.com/tlinux/tsetup.2.3.2.tar.xz) |
...
| Telegram Chrome app | 跨平台 | v0.5.7.1 | [Chrome 网上应用商店](https://chrome.google.com/webstore/detail/telegram/clhhggbfdinjmjhajaheehoeibfljjno) |
...
| 名称 | 支持系统 | 版本 | 下载链接 |
| :--- | :--- | :--- | :--- |
| Telegram for Android \(Google Play\) | Android | 因设备而异 | [Google Play](https://play.google.com/store/apps/details?id=org.telegram.messenger) |
| Telegram for Android \(APK\) | Android | v7.0.1 | [官方下载](https://telegram.org/dl/android/apk) |
| Telegram for iPhone and iPad | iOS 9.0+ & watchOS 5.0+ | v7.0 | [App Store](https://apps.apple.com/app/telegram-messenger/id686449807) |
| Telegram for WP | Windows 8 Mobile+ | v3.4 | [Microsoft Store](https://www.microsoft.com/zh-cn/p/telegram-messenger/9wzdncrdzhs0?rtc=1&activetab=pivot:overviewtab) |
...
| 名称 | 支持系统 | 版本 | 下载链接 |
| :--- | :--- | :--- | :--- |
| Potato for Windows | Windows 7+ | v2.17.200361 | [官方下载](https://download.dppt.in/win/PotatoInstaller.zip) |
| Potato for macOS \(dmg\) | macOS 10.12+ ×64 | v2.17.200504 | [官方下载](https://download.dppt.in/mac/Potato_Desktop.zip) |
| Potato for Linux | Linux ×64 | v2.17.200404 | [官方下载](https://download.dppt.in/linux/Potato_Desktop.tar.gz) |

#### Potato - 移动客户端

| 名称 | 支持系统 | 版本 | 下载链接 |
| :--- | :--- | :--- | :--- |
| Potato for Android \(Google Play\) | Android | v2.16.200101 | [Google Play](https://play.google.com/store/apps/details?id=org.potato.messenger&hl=zh) |
| Potato for Android \(APK\) | Android | v2.16.200101 | [官方下载](https://download.dppt.in/android/potato-2.16.apk) |
| Potato for iOS \(App Store\) | iOS 10.0+ | v2.16.207051 | [App Stone](https://apps.apple.com/us/app/potato-chat/id1204726898) |
| Potato for iOS \(TestFlight\) | iOS 10.0+ | v2.16.207051 | [TestFlight](https://testflight.apple.com/join/P2Jlp35o) |

## 远程协助应用

### ToDesk

官方网站：[https://www.todesk.com/](https://www.todesk.com/)

#### ToDesk - 桌面客户端

| 名称 | 支持系统 | 版本 | 下载链接 |
| :--- | :--- | :--- | :--- |
| ToDesk Windows 版本 | Windows 7+ | v1.1.0828a | [官方链接](https://update.todesk.com/setup_20200828a.exe) |
| ToDesk macOS 版本 | macOS 10.10+ ×64 | v1.0.0904a | [官方链接](https://update.todesk.com/ToDesk1.0.0904a.pkg) |

#### ToDesk - 移动客户端

| 名称 | 支持系统 | 版本 | 下载链接 |
| :--- | :--- | :--- | :--- |
| ToDesk Android 版本 | Android | v1.0.0827a | [官方链接](https://update.todesk.com/todesk.apk) |
| ToDesk iOS 版本 | iOS 9+ | v1.0.2 | [App Store](https://apps.apple.com/cn/app/todesk/id1519407428) |

### AnyDesk

官方网站：[https://anydesk.com/](https://anydesk.com/)
...
| 名称 | 支持系统 | 版本 | 下载链接 |
| :--- | :--- | :--- | :--- |
| Clash for Windows 便携版 | Windows | v0.11.7 | [GitHub](https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.11.7/Clash.for.Windows-0.11.7-win.7z) |
| Clash for Windows 安装版 | Windows | v0.11.7 | [GitHub](https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.11.7/Clash.for.Windows.Setup.0.11.7.exe) |
| Clash for Windows macOS版 | macOS  | v0.11.7 | [GitHub](https://github.com/Fndroid/clash_for_windows_pkg/releases/download/0.11.7/Clash.for.Windows-0.11.7.dmg) |

### Clash\_Chinese\_Patch - Clash for Windows 汉化包

GitHub：[https://github.com/BoyceLig/Clash\_Chinese\_Patch](https://github.com/BoyceLig/Clash_Chinese_Patch)

请自行替换下列路径中的 app.asar 文件：
...
| 名称 | 支持系统 | 版本 | 下载链接 |
| :--- | :--- | :--- | :--- |
| Clashy Windows 便携版 | Windows | v0.1.18 | GitHub |
| Clashy Windows 安装版 | Windows | v0.1.18 | [GitHub](https://github.com/SpongeNobody/Clashy/releases/download/v0.1.18/Clashy-0.1.18.exe) |
